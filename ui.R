library(shiny) #Librarie pentru interfata cu utulizatorul
...
#Aici trebuie sa vorbim de experiment.

# paragrafele accesate in headerul aplicatiei pentru fiecare experiment in parte
# prin intermediul variabilelor de tip "texti" (unde i este un numar natural) mentionate anterior
